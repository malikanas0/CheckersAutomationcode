...
describe('demoqa site automation',()=>{
    it('verify user can enter new data into the table',()=>{
        ...
        cy.get(demoqaverifyaddnewuser.adduserlastname).type('Cantrell').should('have.text', 'Cantrell')
        cy.wait(3000)
    ...
    it('verify user can edit row in a table',()=>{
        ...
        cy.get(verifyeditfunctionality.clearfirstname).clear().type('Gerimedica')
